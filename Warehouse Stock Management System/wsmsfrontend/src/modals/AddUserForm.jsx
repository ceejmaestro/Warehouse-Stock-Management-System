...
import AddUserConfirmation from './confirmationmodals/AddUserConfirmation';

export default function AddUserForm({ onClose, addUser }) {
  ...
  const [isAddUserConfirm, setIsAddUserConfirmOpen] = useState(false);
  ...
  const validate = () => {
    ...
    // Password validation: required, min length 6
    if (!password) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-40">
      ...
      {isAddUserConfirm && (
        <AddUserConfirmation
          onClose={() => setIsAddUserConfirmOpen(false)}
